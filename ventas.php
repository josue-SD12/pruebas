...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ventas (nombre, correo, telefono, direccion, producto, usuario)
            VALUES (?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $nombre, $correo, $telefono, $direccion, $producto, $usuario_registro);
...
<div class="container mt-5">
    <h2><i class="fas fa-user-plus"></i> Registrar una Venta</h2>
