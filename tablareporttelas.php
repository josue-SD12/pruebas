...
<head>
    <meta charset="UTF-8">
    <title>Reportes de Telas Faltantes</title>
...
<div class="container">
    <div class="header">
        <div><i class="fas fa-fabric"></i> Reportes de Telas Faltantes</div>
    ...
    <table>
        ...
        if (isset($_GET['eliminar'])) {
            ...
            $conn->query("DELETE FROM reportes_telas WHERE id = $idEliminar");
        ...
        $total_resultados = $conn->query("SELECT COUNT(*) AS total FROM reportes_telas")->fetch_assoc()['total'];
        $total_paginas = ceil($total_resultados / $por_pagina);

        // 🔹 OBTENER DATOS
        $resultado = $conn->query("SELECT * FROM reportes_telas ORDER BY fecha DESC LIMIT $inicio, $por_pagina");
        ...
        if ($resultado->num_rows > 0) {
            ...
            echo "<tr><td colspan='7'>No hay reportes de telas faltantes.</td></tr>";
        }
