...
<head>
    <meta charset="UTF-8">
    <title>Reportar Telas Faltantes</title>
...
<div class="container">
    <h2><i class="fas fa-fabric"></i> Reportar Telas Faltantes</h2>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($nombre) && !empty($correo) && !empty($descripcion) && !empty($producto)) {
            $sql = "INSERT INTO reportes_telas (nombre, correo, descripcion, producto) 
