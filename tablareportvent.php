...
<div class="container">
    <div class="header">
        <div><i class="fas fa-clipboard-list"></i> Reportes Registrados</div>
    ...
    <table>
        ...
        if (isset($_GET['eliminar'])) {
            ...
            $conn->query("DELETE FROM reportes WHERE id = $idEliminar");
        ...
        $total_resultados = $conn->query("SELECT COUNT(*) AS total FROM reportes")->fetch_assoc()['total'];
        $total_paginas = ceil($total_resultados / $por_pagina);

        // 🔹 OBTENER DATOS
        $resultado = $conn->query("SELECT * FROM reportes ORDER BY fecha DESC LIMIT $inicio, $por_pagina");
        ...
        if ($resultado->num_rows > 0) {
            ...
            echo "<tr><td colspan='9'>No hay reportes registrados.</td></tr>";
        }
